  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://xbz0n.sh/blog" />
        <meta property="og:title" content="xbz0n | Security Research Blog" />
        <meta property="og:description" content="Security research articles covering penetration testing, exploit development, red team operations, Active Directory attacks, and CVE disclosures." />
        ...
        <meta name="twitter:title" content="xbz0n | Security Research Blog" />
        <meta name="twitter:description" content="Security research articles covering penetration testing, exploit development, red team operations, Active Directory attacks, and CVE disclosures." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "BreadcrumbList",
              "itemListElement": [
                { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://xbz0n.sh/" },
                { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://xbz0n.sh/blog" }
              ]
            })
          }}
        />

        {/* Blog ItemList Schema.org */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Blog",
              "name": "xbz0n | Security Research Blog",
              "url": "https://xbz0n.sh/blog",
              ...
              "blogPost": posts.slice(0, 10).map(p => ({
                "@type": "BlogPosting",
                "headline": p.title,
                "url": `https://xbz0n.sh/blog/${p.slug}`,
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {post.tags && post.tags.slice(0, 3).map(tag => (
                    <Link key={tag} href={`/blog/tag/${slugifyTag(tag)}`} className="inline-block">
                      <span
                        className={`badge ${
...
export async function getStaticProps() {
  ...
  try {
    ...
    posts = markdownFiles.map((fileName) => {
      ...
      const excerpt = data.description || generateExcerpt(content);
