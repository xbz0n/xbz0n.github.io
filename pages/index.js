  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Offensive security consultant specializing in penetration testing, red teaming, vulnerability research, and exploit development. Published CVEs and tools." />
        <link rel="canonical" href="https://xbz0n.sh/" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://xbz0n.sh/" />
        <meta property="og:title" content="xbz0n@sh:~# Command Line to Front Line" />
        <meta property="og:description" content="Offensive security consultant specializing in penetration testing, red teaming, vulnerability research, and exploit development." />
        <meta property="og:site_name" content="xbz0n.sh" />
        <meta property="og:image" content="https://xbz0n.sh/images/dep-bypass.jpeg" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@xbz0n" />
        <meta name="twitter:creator" content="@xbz0n" />
        <meta name="twitter:image" content="https://xbz0n.sh/images/dep-bypass.jpeg" />
        <meta name="twitter:title" content="xbz0n@sh:~# Command Line to Front Line" />
        <meta name="twitter:description" content="Offensive security consultant specializing in penetration testing, red teaming, vulnerability research, and exploit development." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "knowsAbout": ["Penetration Testing", "Red Teaming", "Vulnerability Research", "Exploit Development"],
              "sameAs": [
        ...
        {/* Schema.org — WebSite (sitelinks signal) */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebSite",
              "name": "xbz0n.sh",
              "alternateName": "xbz0n | Security Research Blog",
              "url": "https://xbz0n.sh",
              "description": "Offensive security research, exploit development, red team operations, and CVE disclosures by Ivan Spiridonov (xbz0n).",
              "inLanguage": "en",
              "publisher": {
                "@type": "Person",
                "name": "Ivan Spiridonov",
...
export async function getStaticProps() {
  ...
  const allPosts = markdownFiles.map((fileName) => {
    ...
    // Prefer explicit frontmatter `description:` if present.
