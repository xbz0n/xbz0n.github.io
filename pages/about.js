  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://xbz0n.sh/about" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://xbz0n.sh/about" />
        <meta property="og:title" content="xbz0n | About Ivan Spiridonov" />
        <meta property="og:description" content="Offensive Security Consultant with OSCP, OSEP, OSWE, OSED, OSCE³ certifications. Expert in penetration testing, Active Directory attacks, and exploit development." />
        ...
        <meta name="twitter:title" content="xbz0n | About Ivan Spiridonov" />
        <meta name="twitter:description" content="Offensive Security Consultant with OSCP, OSEP, OSWE, OSED, OSCE³ certifications. Expert in penetration testing, Active Directory attacks, and exploit development." />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "About", "item": "https://xbz0n.sh/about" }
              ]
            })
          }}
        />
