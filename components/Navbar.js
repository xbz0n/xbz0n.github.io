      ...
      <div className="container py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a href="https://app.hackthebox.com/public/users/8208" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-accent" aria-label="HackTheBox">
          ...
          <div className="md:hidden mt-4 pb-2 space-y-4">
            ...
            */}
            ...
            <div className="flex justify-evenly items-center pt-4 pb-2 border-t border-gray-700">
              ...
              <a href="https://app.hackthebox.com/public/users/8208" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center text-gray-300 hover:text-accent" aria-label="HackTheBox">
                <SiHackthebox className="w-6 h-6 mb-1" />
                <span className="text-xs">HTB</span>
              </a>
            </div>
          </div>
        )}
